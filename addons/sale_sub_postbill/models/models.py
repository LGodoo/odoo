...
class AccountBankStatementLine(models.Model):
    ...
    def _telecom_cron(self):
        ...
        urlTransactionsList = 'https://omega-telecom.net/api/json/transactions/list/'
        urlCallHistory = 'https://omega-telecom.net/api/json/cdrs/list/'
        urlCustomerList = 'https://omega-telecom.net/api/json/customers/list/'
