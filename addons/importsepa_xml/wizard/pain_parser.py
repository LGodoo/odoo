...
class PainParser(object):
    ...
    def parse_msgid(self,root):
        ...
        # if root.findall('.//OrgnlMsgId'):
        #     _logger.error("haHAA")
        #
        #     for OrgnlMsgId in root.iter('TrxInf'):
        #         msgidval = OrgnlMsgId.find('OrgnlMsgId').text
        #         if msgidval:
        #             msgid.append(msgidval)
        #         else:
        #             msgid.append('')
        #     _logger.error("haHAA2")
        #     return msgid
    ...
    def parse_errorcode(self,root):
        ...
        if root.findall('.//CollectionAmount'):
            ...
            for Cd in root.iter('{urn:iso:std:iso:20022:tech:xsd:pain.002.001.03}OrgnlPmtInfAndSts'):
